...
//                }
                Setting::where(['id' => $id])->update([
                    ...
                    'tel_header' => $data['tel_header'],
//                    'logo_path' => $large_path,
                    'bn_textbox' => $data['bn_textbox'], 'address' => $data['address'],
//                    'reference' => $data['reference'],
                    'credit_term' => $data['credit_term'],
                    'narezayati_text' => $data['narezayati_text'],
                    'hamkari_text' => $data['hamkari_text'],
//                    'tamas_text' => $data['tamas_text']
                ]);
...
//                $s->logo_path = $large_path;
                ...
                $s->narezayati_text = $data['narezayati_text'];
                $s->hamkari_text = $data['hamkari_text'];
//                $s->tamas_text = $data['tamas_text'];
                $s->save();
                return redirect()->back();
            }
        }
