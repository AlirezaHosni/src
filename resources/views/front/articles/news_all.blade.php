            ...
            <div class="col-sm-12">
                <section class="bn_main_section">
                    <div class="bn_main_content old">
                        ...
                        <form method="post" action="{{ route('news.search') }}" class="bn_header_search">
                            @csrf
                            <input class="bn-search-input" type="text" name="newsTitle" required
                                   placeholder="اخبار خود را جستجو کنید...">
                                        ...
                                        <a href="{{ url('/news/'.$row->slug) }}">
                                            <div class="bn_nl_text style2">
                                                <div class="bn_nl_no style2">
                                                    <span class=" bn_nln_name">اخبار </span>
