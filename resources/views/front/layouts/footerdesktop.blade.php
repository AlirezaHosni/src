                        ...
                        <div class="links-col">
                            ...
                            <ul class="links-ul">
                                ...
                                @forelse($mfootera as $row)
                                    <li><a href="{{ url('/pages/'.$row->page->slug??'') }}">{{ $row->title }}   </a>
                                    </li>
                                @empty
                                @endforelse
                            </ul>
            ...
            <nav class="footer-address ">
                ...
                <div class="footer__address-images">
                    ...
                    <a class="footer__address-appstore">
                        <img
                                data-src="{{ asset('assets/s/692fd5db.svg') }}"
                                src="{{ asset('assets/s/692fd5db.svg') }}"
                                alt="دریافت از مایکت"
                                width="150px"></a>
                    <a class="footer__address-appstore">
                        <img
                    ...
                    <div class="footer__description-content">
                       <div class="row">
                          <div class="col-md-8 col-lg-8 pull-right">
                              <article class="footer__seo" style="display: block;text-align: right;">
