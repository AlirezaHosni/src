...
<section class="p-tabs">
    ...
    <div class="c-box--tabs p-tabs__content">
        <div id="desc" class="c-content-expert is-active">
            <article>
                <h2 style="font-family: inherit !important;" class="en-title c-params__headline"> بررسی تخصصی
...
<div id="params">
    <article>
        <h2 style="font-family: inherit !important;" class="en-title c-params__headline"> جزییات فنی
            <span> {{ $productDetails->title }} </span>
        </h2>
        {!!  $productDetails->fani !!}
    </article>
...
<div id="power">
    <article>
        <h2 style="font-family: inherit !important;" class="en-title c-params__headline"> نقاط قوت و ضعف :
            <span> {{ $productDetails->title }} </span>
        </h2>
        <section class="c-content-expert__summary">
            <div class="c-mask">
...
<div id="download">
    <article>
        <h2 style="font-family: inherit !important;" class="en-title c-params__headline"> دانلود فایل ها مورد نظر:
            <span> {{ $productDetails->title }} </span>
        </h2>
        <section class="c-content-expert__summary">
...
<div id="comments">
    <h2 style="font-family: inherit !important;" class="en-title c-comments__headline"> امتیاز کاربران به:
        <span>{{ $productDetails->title }}</span>
    </h2>
                ...
                @foreach($comments as $comment)
                    <li class="is-question">
                        <div class="section">
                            ...
                            <p>{{ $comment->body }}</p>
                            <p>پاسخ سایت : {{$comment->body_answer}}</p>
                            <div class="footer">
