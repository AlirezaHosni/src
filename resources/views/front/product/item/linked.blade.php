...
{{--        <div--}}
             style="transform: translate3d(239.25px, 0px, 0px); transition-duration: 0ms;  width:350px">
{{--             style=" width:350px">--}}
            @forelse($linkeds as $row)
{{--                <div class="product-item swiper-slide swiper-slide-prev" style="font-size: 1em;">--}}
                <div class="product-item @if($linkeds->count() > 2) swiper-slide @endif swiper-slide-prev" style="width: 229.25px; margin-left: 10px;font-size: 1em;">
