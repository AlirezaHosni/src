    ...
    <div class="content-inner">
        <div class="container-fluid">
            <div class="o-page__content">
                ...
                <div class="row">
                    <button id="PdfMake" class="mt-2 mb-2 btn btn-info">ساخت PDF</button>
                </div>
                        ...
                        <div class="c-checkout-details__col--table">
                            <div class="c-checkout-table">
                                <div class="c-checkout-table__row">
                                    <div class="c-checkout-table__col"><span>نام تحویل گیرنده: {{ $userProfileDetail->first_name??'' }} - {{ $userProfileDetail->last_name??'' }}  </span>
                                    </div>
                                    <div class="c-checkout-table__col">
                                        <span>شماره تماس :  {{ $userDetail->phone }}</span></div>
                                </div>
                                <div class="c-checkout-table__row">
                                    <div class="c-checkout-table__col"><span>تعداد مرسوله : ۱ </span></div>
                                    <div class="c-checkout-table__col c-price">
                                        <span>مبلغ کل: {{ $order->total }} ریال </span></div>
                                </div>
                                <div class="c-checkout-table__row">
                            ...
                            <div class="c-checkout-table">
                                @forelse($prodcutorders as $cart)
                                    <div class="c-checkout-table__row">
                                        ...
                                        ?>
                                        <div class="c-checkout-table__col"><img style="width: 75px;height: 75px;"
                                                                                src="{{ asset($cover??'') }}" alt="">
                                        </div>
                                        ...
                                        <div class="c-checkout-table__col c-price">قیمت محصول
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{asset('assets/js/jquery.printElement.min.js')}}"></script>
    <script>
