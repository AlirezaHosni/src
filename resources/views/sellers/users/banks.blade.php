                    ...
                    <div class="widget has-shadow">
                        ...
                        <div class="widget-body">
                            ...
                            <form action="{{ route('sellers.bank.update') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <h4 id="alarm" style="margin-top: 20px;
                                margin-bottom: 20px;
                                text-align: center;
                                color: green;display: none;">
                                توضیحات :
                                لطفا شماره کارت  و شماره شبا به اسم فرد صاحب حساب باشد
                            </h4>
                                <div class="credit-card-wrapper form-group row d-flex align-items-center mb-5">
                                    <label class="col-lg-2 form-control-label d-flex justify-content-lg-end">شماره کارت (لطفا ۱۶ رقم وارد کنید) 
                                    </label>
                                    <div class="col-lg-6">
                                        <input  maxlength="16" minlength="16" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required type="text" name="card_bank" {{--id="cardnumber"--}}
...
@section('scripts')
    ...
    <script src="{{ asset('assets/jquery.maxlength.css') }}"></script>
    <script src="{{ asset('assets/jquery.plugin.js') }}"></script>
    <script src="{{ asset('assets/jquery.maxlength.js') }}"></script>
    <script>
