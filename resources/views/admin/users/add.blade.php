                            ...
                            <div class="card-body table-responsive p-0">
                                <form method="post" action="{{ url('ad/users/add') }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label>با انتحاب نقش در بخش اصلی دسترسی‌های مخصوص آن نقش به کارمند داده می‌شود ولی اگر دسترسی خاصی به این کارمند میخواهید اعطا کنید انتخاب کنید(می‌تواند خالی بماند)</label>
