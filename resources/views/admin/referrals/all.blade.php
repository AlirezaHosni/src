            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <form  action="{{ route('referral.changeRefText') }}" method="post" class="col-12 mt-1">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">متن مرجوع کالا</label>
                                            <textarea name="reference" class="form-control" id="reference" cols="30" rows="10">{{ $setting->reference ?? '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
