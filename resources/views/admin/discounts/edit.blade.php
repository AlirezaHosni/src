    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>ویرایش محصول شگفت انگیز </h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            <li class="breadcrumb-item"><a href="{{ route('ad.dashboard') }}">خانه</a></li>
                            <li class="breadcrumb-item active">ویرایش محصول شگفت انگیز</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">ویرایش محصول شگفت انگیز </h3>

                            </div>
                            <!-- /.card-header -->
                            <div class="card-body table-responsive p-0">
                                <form method="post" action="{{ url('/ad/products/edit-countdown/'.$coun->id) }}"
                                    ...
                                    <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="product_id" class="form-control">
                                                        ...
                                                        @foreach($products as $products)
                                                            <option {{ $products->id==$coun->product_id?'selected':'' }} value="{{$products->id}}">{{$products->title}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="special_type" class="form-control">
                                                        ...
                                                        <option {{ $coun->special_type=="Percentage"?'selected':'' }} value="Percentage" selected>تخفیف بر اساس درصد</option>
                                                        <option {{ $coun->special_type=="Fixed"?'selected':'' }} value="Fixed">تخفیف بر اساس مبلغ خاص</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <input {{ $coun->special=="1"?'checked':'' }} type="checkbox" class="browser-default" name="special"
                                                       id="special"
