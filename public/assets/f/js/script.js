$(document).ready(function() {
        ...
        var pslider= {
            slidesPerView:3, spaceBetween:3, loop: true, autoplay: {
                delay: 2000, disableOnInteraction: !1,
            }
            , navigation: {
            ...
            , breakpoints: {
                1024: {
                    slidesPerView: 3, spaceBetween: 3,centeredSlides: true,
   ...
   centeredSlidesBounds: true
                ...
                , 640: {
                    slidesPerView: 2, spaceBetween: 3,centeredSlides: true,
   centeredSlidesBounds: true
                }
                , 320: {
                    slidesPerView: 1, spaceBetween: 3,centeredSlides: true,
   centeredSlidesBounds: true
                }
            }
        }
