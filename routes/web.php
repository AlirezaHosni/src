...
//req
    Route::match(['get', 'post'], '/req/{url}', 'IndexController@req')->middleware('auth');
//product
...
//catgoery news article
    ...
    Route::post( '/news/search', 'ArticleController@searchNews')->name('news.search');
//brands
...
// Users Register Form Submit
    ...
    Route::group(['prefix' => 'user'], function () {
        ...
        Route::match(['get','post'],'/forget-paginssword','UsersController@forgetpass')->name('forgetpass');
