    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class=" col-md-2 offset-md-1">
                <a href="{{ url('/ad/reqforms/add') }}" class="btn btn-block btn-outline-success">ایجاد درخواست فرم
                </a>
            </div>
        </div>
        <br>
                                    ...
                                    @forelse($cat as $key => $row)
                                        <tr>
                                            ...
                                            <th>
                                                <div class="tools">
                                                    <div class="row">
                                                        <a href="{{ url('/ad/reqforms/edit/'.$row->id) }}"
                                                           style="margin-right: 10px;margin-left: 10px;">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <a id="delRole" rel="{{ $row->id }}"
                                                           rel1="reqforms/delete"
                                                           href="javascript:"
                                                           class="deleteRecord">
