    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>نمایش  سوالات متداول ({{  $cat_name??'' }})   </h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            <li class="breadcrumb-item"><a href="{{ route('ad.dashboard') }}">خانه</a></li>
                            <li class="breadcrumb-item active">نمایش  سوالات متداول موجود</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="row">
            ...
            <div class=" col-md-2 offset-md-1">
                <a href="{{  url('/ad/faqs/add/'.$cat_id) }}" class="btn btn-block btn-outline-success">ایجاد  سوالات 
                </a>
            </div>
        </div>
        <br>
                                    ...
                                    @forelse($faq as $key => $row)
                                        <tr>
                                            ...
                                            <th>
                                                <div class="tools">
                                                    <div class="row">
                                                        <a href="{{ url('/ad/faqs/edit/'.$row->id) }}"
